...
torch.save(train_dict, '/home/hviswan/Documents/new_dataset/WaterDropSmall/WaterDrop_train.pt')

ds = tf.data.TFRecordDataset([os.path.join(datapath, 'waterdrop_test.tfrecord')])
ds = ds.map(functools.partial(parse_serialized_simulation_example, metadata=metadata))
...
train_dict = {'particle_type':particle_type, 'position':position, 'n_particles_per_example':n_particles_per_example, 'output':y}
torch.save(train_dict, '/home/hviswan/Documents/new_dataset/WaterDropSmall/WaterDropSample_test.pt')


ds = tf.data.TFRecordDataset([os.path.join(datapath, 'waterdrop_valid.tfrecord')])
ds = ds.map(functools.partial(parse_serialized_simulation_example, metadata=metadata))
...
torch.save(rollout_dict, '/home/hviswan/Documents/new_dataset/WaterDropSmall/WaterDropSample_rollout.pt')
